...
F = 0; % Вычисление суммы квадратов
...
fprintf( 'Уравнение линейной регресии: \n\n' )
P = a_0 + a_1 * x;
disp( P )
...
fprintf( 'Среднее значение точек x и y: \n\n' )
disp( mean( x_10 ) )
disp( mean( y_10 ) )

fprintf( 'Смещённая и несмещённая оценки среднеквадратичного отклонения x: \n\n' )
disp( std( x_10, 0 ) );
disp( std( x_10, 1 ) );

fprintf( 'Смещённая и несмещённая оценки среднеквадратичного отклонения y: \n\n' )
disp( std( y_10, 0) );
disp( std( y_10, 1) );

fprintf( 'Коэффициент корреляции: \n\n' ) 
